document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderTasks() {
        ...
        showHomeButton(false); // Hide Home button when rendering all tasks
    }
    ...
    function createTaskElement(task, index) {
        ...
        // HTML structure of a task item with task title followed by an arrow icon
        ...
        // Select elements for the arrow icon and the description
        ...
        // Toggle description visibility on arrow click
    ...
    function startInlineEdit(taskElement, task, index) {
        ...
        // Hide other buttons (including priority label) when in edit mode
    ...
    function saveInlineEdit(index, taskElement) {
        ...
        tasks[index].priority = document.getElementById("editPriority").value; // Get the new priority

        saveTasksToLocalStorage();
        renderTasks();

        // Remove the edit form and restore buttons
    ...
    function cancelInlineEdit(taskElement) {
        ...
        // Restore the visibility of other buttons
    ...
    homeButton.addEventListener("click", () => {
        showHomeButton(false); // Hide home button when clicked
        renderTasks(); // Reset to show all tasks
    });
